...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 6tCWMqfoVKTN/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: JWxKibrd0nQl/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__mayVk)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__cy1S5)}
              />
            </React.Fragment>
          ),
          value: args.children
